...
let user2 = ["admin", "eric", "hasnain", "faizan", "yasir"];
if (user2.length === 0) {
...
let current_users = ["Admin", "Eric", "Hasnain", "Faizan", "Yasir"];
let new_users = ["Admin", "Eric", "Haseeb", "Adil", "Ahmed"];
...
let favorite_pizza = ["fajita", "chickentikka", "pepperoni"];
