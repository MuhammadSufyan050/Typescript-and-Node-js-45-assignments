...
let names: string [] = ["Ahmed Raza","Abdul Rafey","Mustafa","Rabeel"]
...
var message: string = "Do you like play cricket"
...
let transportation: string [] = ["Honda Motorcycle","Honda City","Kia Sportage"]
...
let Guest: String [] = ["Hassam","Hasnain","Yasir"]
...
let guests1: string [] = ["Hassam","Hasnain","Yasir"]

let canNotAttend: string = "Hassam"
console.log(canNotAttend + "" ,"can not attend the dinner.")

let newGuest: string = "Idrees"
...
let guest:string [] = ['Mustafa', 'Idrees', 'Hassam', 'Hasnain', 'Yasir']
...
let placesToVisit: string [] = ["Uae","Turkey","England","Switzerland","America"]
...
let invitations: string [] = [ "Mustafa","Idrees"]
