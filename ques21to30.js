...
let person = { name: "Abdul Rafey", gender: "Male", age: 18 };
console.log(person);
console.log("----------------------------------");
// Q22-
...
let name_1 = "Muhammad Sufyan";
let name_2 = "Ahmed Raza";
let name_3 = "Abdul Rafey";
if (name_1 == name_3) {
...
let users1 = ["admin", "eric", "hasnain", "faizan", "yasir"];
